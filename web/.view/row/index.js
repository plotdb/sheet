...
pug_html = pug_html + "\u003Cstyle type=\"text\u002Fcss\"\u003Ehtml,body{width:100%;height:100%;background:#fff}.sheet{position:relative;border-width:1px;border-style:solid;border-color:#999;width:fit-content}.sheet .srow{display:grid;grid-template-columns:repeat(28,48px);width:fit-content}.sheet .scell{user-select:none;border-width:0 1px 1px 0;border-style:solid;border-color:#ddd;padding:1px;min-width:48px;min-height:26px;line-height:26px;flex:0 0 auto;box-sizing:border-box}.sheet .scell:last-child{border-right-width:0}.sheet .srow:last-child .scell{border-bottom-width:0}.sheet .srow.idx,.sheet .srow .scell:first-child{position:sticky;background:#f1f2f3;color:#919293;font-size:.85em;text-align:center}.sheet .srow.idx{z-index:101;top:0}.sheet .srow .scell:first-child{z-index:100;left:0}.sheet .scell.idx{user-select:none}.sel{z-index:10;border:1px solid #27f;position:absolute;display:none;user-select:none;pointer-events:none}.sel-main{z-index:11;border:2px solid #27f;position:absolute;display:none;user-select:none;pointer-events:none}.edit{z-index:21;border:2px solid #27f;position:absolute;display:none}.edit textarea{position:absolute;top:0;left:0;width:100%;height:100%;border:0;outline:0}\u003C\u002Fstyle\u003E\u003C\u002Fhead\u003E\u003Cbody\u003E\u003Cdiv class=\"w-1024 rwd mx-auto my-4\"\u003E\u003Cdiv class=\"aspect-ratio ratio-2by1\"\u003E\u003Cdiv class=\"sheet w-100 h-100\" style=\"overflow:scroll\"\u003E\u003Cdiv class=\"edit\"\u003E\u003Ctextarea\u003E\u003C\u002Ftextarea\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"sel\"\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"sel-main\"\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"sel-main\"\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"srow idx\"\u003E";
...
pug_html = pug_html + "\u003Cdiv class=\"scell idx\"\u003E" + (pug_escape(null == (pug_interp = i) ? "" : pug_interp)) + "\u003C\u002Fdiv\u003E";
      }
  } else {
    var $$l = 0;
...
pug_html = pug_html + "\u003Cdiv class=\"srow\"\u003E\u003Cdiv class=\"scell idx\"\u003E" + (pug_escape(null == (pug_interp = m + ( k - 1 ) * 6) ? "" : pug_interp)) + "\u003C\u002Fdiv\u003E\u003Cdiv class=\"scell\"\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"scell\"\u003E\u003C\u002Fdiv\u003E";
// iterate [1,2,3,4,5]
;(function(){
  var $$obj = [1,2,3,4,5];
  if ('number' == typeof $$obj.length) {
